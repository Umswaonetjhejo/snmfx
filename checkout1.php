...
<!--                        <td>Adam</td>-->
            ...
            <div class="w3-third w3-container">
                ...
                <input type="hidden" name="merchant_id" value="10012440">
                <input type="hidden" name="merchant_key" value="m66szar4qtsrg">
                ...
                <input type="hidden" name="signature" value="7fe737c92ea885c193cdf2e8ee795609">
...
{
    // Construct variables
    $cartTotal =  trim($_POST['amount']);// This amount needs to be sourced from your application
    ...
    $data = array(
        ...
        // Transaction details
        'm_payment_id' =>  trim($_POST['m_payment_id']), //Unique payment ID to pass through to notify_url
        ...
        'custom_int1' =>  trim($_POST['custom_int1']), //custom integer to be passed through
        'custom_str1' =>  trim($_POST['custom_str1'])
    );
    ...
    $data['signature'] = md5( trim($_POST['signature']) );
}
